function createSidebarContent(prefix) {
	...
	const items = {
		...
		'extraButtonJustReleased': 'mobile.html',
		'extraButtonReleased': 'mobile.html',
		'vibrate': 'mobile.html',
		'addTouchPad': 'mobile.html',
		'removeTouchPad': 'mobile.html',
		'addTouchPadCamera': 'mobile.html',
		'touchPadJustPressed': 'mobile.html',
		'touchPadPressed': 'mobile.html',
		'touchPadJustReleased': 'mobile.html',
		'touchPadReleased': 'mobile.html',
		'touchJustPressed': 'mobile.html',
		'touchPressed': 'mobile.html',
		'touchJustReleased': 'mobile.html',
		'touchReleased': 'mobile.html',
		'touchPressedObject': 'mobile.html',
		'touchJustPressedObject': 'mobile.html',
		'touchJustReleasedObject': 'mobile.html',
		'touchReleasedObject': 'mobile.html',
		'touchPressedObjectComplex': 'mobile.html',
		'touchJustPressedObjectComplex': 'mobile.html',
		'touchJustReleasedObjectComplex': 'mobile.html',
		'touchReleasedObjectComplex': 'mobile.html',
		'touchOverlapsObject': 'mobile.html',
		'touchOverlapsObjectComplex': 'mobile.html',
		'isAndroidTV': 'mobile.html',
		'isTablet': 'mobile.html',
		'isChromebook': 'mobile.html',
		'isDeXMode': 'mobile.html',
		'isDolbyAtmos': 'mobile.html',
		'backJustPressed': 'mobile.html',
		'backPressed': 'mobile.html',
		'backJustReleased': 'mobile.html',
		'menuJustPressed': 'mobile.html',
		'menuPressed': 'mobile.html',
		'menuJustReleased': 'mobile.html',
		'getCurrentOrientation': 'mobile.html',
		'setOrientation': 'mobile.html',
		'minimizeWindow': 'mobile.html',
		'manualBackButton': 'mobile.html',
		'showToast': 'mobile.html',
		'isScreenKeyboardShown': 'mobile.html',
